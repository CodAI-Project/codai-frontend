        ...
        <div className=' flex-grow-0 teste'>
            <div className=''>
                <motion.div animate={controls}
                    className={
                        `max-w-[250px] p-2 h-screen animate duration-300 relative flex flex-col group ${
                            active ? '' : 'w-16 mx-auto text-center'
                        }`
                }>
                    <div className='bg-blackcodai-950 py-6 h-full rounded-3xl overflow-hidden'>
                        {/* Adicionando overflow-hidden para a div da lista de chats */}
                        <div className={
                            `px-5 flex flex-wrap teste flex-row gap-5 items-center ${
                                ...
                                <Button onClick={createNewChat}
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <motion.p animate={controlText}
                                            className='ml-4 text-sm font-bold text-gray-400'>Gerar novo template</motion.p>
                                    </div>
                                </Button>
                            </Tooltip>
                        </div>

                        <div className='grow items-center overflow-y-auto'
                            style={
                                {
                        ...
                        <div className="absolute bottom-5 left-0 right-0 p-4 flex justify-center items-center">
                            {
                            active ? (
                                <TbLayoutSidebarRightExpand onClick={showLess}
                                    className='text-2xl text-gray-400 cursor-pointer'/>
                            ) : (
                                <TbLayoutSidebarLeftExpand onClick={showMore}
                                    className='text-2xl text-gray-400 cursor-pointer'/>
                            )
                        } </div>
